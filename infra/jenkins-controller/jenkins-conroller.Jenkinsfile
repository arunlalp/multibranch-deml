...
def PROJECT_DIR = 'infra/jenkins-controller'
def TF_VARS_FILE = 'jenkins-controller.tfvars'
def PLAN_FILE = 'tfplan.binary'
def PLAN_JSON_FILE = 'tfplan.json'
def TFVARS_FILE_PATH = '../../vars/infra/dev/jenkins-controller.tfvars'
def CUSTOM_POLICY = 'CUSTOM_AWS_*'
def NOTIFICATION_EMAIL = 'arunsample555@gmail.com' 
def STATE_FILE = "jenkins_controller.tfstate"
